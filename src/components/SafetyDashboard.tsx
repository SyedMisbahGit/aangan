...
import { Shield, AlertTriangle, TrendingUp, Users, Activity, CheckCircle } from "lucide-react";
...
export const SafetyDashboard = () => {
  ...
  const [recentAlerts] = useState([
    ...
    },
    {
      id: 3,
      type: "system",
      message: "AI moderation confidence dropped to 89% - manual review queue activated",
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-2 mb-4">
        ...
        <h2 className="text-xl font-bold text-white">Safety & Moderation Dashboard</h2>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        <Card className="bg-white/5 backdrop-blur-md border-white/10 p-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-white">{safetyMetrics.postsModerated}</div>
        ...
        <Card className="bg-white/5 backdrop-blur-md border-white/10 p-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-yellow-400">{safetyMetrics.flaggedContent}</div>
        ...
        <Card className="bg-white/5 backdrop-blur-md border-white/10 p-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-green-400">{safetyMetrics.safetyScore}%</div>
        ...
        <Card className="bg-white/5 backdrop-blur-md border-white/10 p-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-red-400">{safetyMetrics.emergencyProtocols}</div>
        ...
        <Card className="bg-white/5 backdrop-blur-md border-white/10 p-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-blue-400">{safetyMetrics.communityReports}</div>
        ...
        <Card className="bg-white/5 backdrop-blur-md border-white/10 p-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-purple-400">{safetyMetrics.averageResponseTime}</div>
