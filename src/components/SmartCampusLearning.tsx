...
import { MapPin, Plus, TrendingUp, Lightbulb, Users, Clock } from 'lucide-react';
  ...
  const startLearning = () => {
    ...
    setTimeout(() => {
      ...
      const newZone: DiscoveredZone = {
        ...
        avgEmotion: ['joy', 'nostalgia', 'loneliness', 'calm'][Math.floor(Math.random() * 4)],
        isAutoCreated: true,
    ...
    <div className="whisper-orb floating-orb p-8 max-w-6xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="kinetic-text-slow text-gray-300 max-w-2xl mx-auto">
          ...
          New hotspots are auto-created, and patterns are shared across campuses.
        </p>
      </div>
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="text-right">
                    <div className="text-lg font-bold text-white">{zone.whisperCount}</div>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <span className="text-white ml-2 capitalize">{zone.avgEmotion}</span>
                  </div>
                  <div>
        ...
        <div className="whisper-glass p-6 rounded-2xl">
            ...
            {learningPatterns.map((pattern, index) => (
              ...
              >
                ...
                <div className="flex items-center justify-between text-xs">
                  <span className="text-gray-400">Campus: {pattern.campus}</span>
          ...
          <div className="mt-6 p-4 rounded-xl bg-gradient-to-r from-blue-500/10 to-indigo-500/10 border border-blue-400/20">
            ...
            <p className="text-sm text-gray-300">
              Based on CUJ patterns, new campuses will likely discover similar zones:
              "Hostel Whisper Corners", "Canteen Social Hubs", "Library Stress Zones"
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="whisper-glass p-4 rounded-xl text-center">
          <div className="text-2xl font-bold text-white mb-1">
            {Math.round(discoveredZones.reduce((sum, z) => sum + z.confidence, 0) / discoveredZones.length)}%
          </div>
