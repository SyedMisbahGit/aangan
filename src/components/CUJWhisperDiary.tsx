...
import { BookOpen, Heart, Sparkles, Clock, Eye, Home, GraduationCap, Moon, Coffee, Music } from 'lucide-react';
...
const CUJWhisperDiary: React.FC = () => {
  ...
  const [promptPack, setPromptPack] = useState<'north-soul' | 'dogri-echoes' | 'cuj-life'>('north-soul');
  ...
  const cujMoods = [
    { name: 'melancholy', emoji: '🌙', dogri: 'Udaas', context: 'Hostel ki raat' },
    { name: 'hopeful', emoji: '✨', dogri: 'Umeed', context: 'Udaan memories' },
    { name: 'grateful', emoji: '💝', dogri: 'Shukriya', context: 'Campus life' },
    { name: 'confused', emoji: '🌀', dogri: 'Uljhan', context: 'Exam pressure' },
    { name: 'peaceful', emoji: '🕊️', dogri: 'Shanti', context: 'Library silence' },
    { name: 'yearning', emoji: '💫', dogri: 'Tadap', context: 'Ghar ki yaad' },
    { name: 'excited', emoji: '🎉', dogri: 'Utsah', context: 'Fest season' },
    { name: 'stressed', emoji: '😰', dogri: 'Tension', context: 'Lab submission' },
  ];
  ...
  const handleSubmit = async () => {
    ...
    const newEntry: DiaryEntry = {
      ...
      isAnonymous: true,
      culturalContext: culturalContexts[Math.floor(Math.random() * culturalContexts.length)],
    };
