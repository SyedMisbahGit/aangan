...
import { Heart, MessageCircle, Share2, Flag, Clock, TrendingUp } from "lucide-react";
...
export const PostFeed = ({ refreshTrigger }: PostFeedProps) => {
  ...
  const samplePosts: Post[] = [
    {
      id: "1",
      content: "The new cafeteria food is actually amazing! Finally some variety and the portions are generous. Shoutout to whoever made this happen 🙌",
      category: "💬 Confession",
    ...
    {
      id: "2",
      content: "Anyone else feeling overwhelmed with the workload this semester? It feels like every professor thinks their subject is the only one we're taking...",
    ...
    {
      id: "3",
      content: "PSA: The library WiFi is down on the 3rd floor. IT says it'll be fixed by tomorrow morning. Study accordingly!",
  ...
  return (
    <div className="space-y-4">
      ...
      {posts.map((post) => (
        <Card key={post.id} className="bg-white/5 backdrop-blur-md border-white/10 p-6 hover:bg-white/10 transition-all duration-300">
          <div className="space-y-4">
            {/* Header */}
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2 text-sm text-gray-400">
                <div className={`w-2 h-2 rounded-full ${getSentimentColor(post.sentiment)}`} />
            ...
            <div className="flex items-center justify-between pt-2 border-t border-white/10">
              <div className="flex items-center space-x-6">
                <Button variant="ghost" size="sm" className="text-gray-400 hover:text-pink-400 hover:bg-pink-400/10">
