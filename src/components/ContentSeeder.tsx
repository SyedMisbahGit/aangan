...
export const ContentSeeder = () => {
  const [seedPosts] = useState<SeedPost[]>([
    {
      id: "seed1",
      content: "Anyone else think the new library hours are actually perfect for late-night study sessions? Finally somewhere quiet after 10pm!",
    ...
    {
      id: "seed2", 
      content: "PSA: The coffee machine on the second floor of the student center is broken again. Save your money and go to the third floor!",
    ...
    {
      id: "seed3",
      content: "Just wanted to say thank you to whoever left encouraging sticky notes in the bathroom stalls during finals week. You made my day! 💚",
      category: "💬 Confession",
  ...
  return (
    <div className="space-y-4">
      ...
      {seedPosts.map((post) => (
        <Card key={post.id} className="bg-white/5 backdrop-blur-md border-white/10 p-4">
