...
import { AlertTriangle, CheckCircle, XCircle, Eye, ThumbsUp, ThumbsDown } from "lucide-react";
...
export const ModerationFeedback = ({ postId, moderationResult }: ModerationFeedbackProps) => {
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <Badge className={getStatusColor(moderationResult.action)}>
              {moderationResult.action.charAt(0).toUpperCase() + moderationResult.action.slice(1)}
            </Badge>
        ...
        {moderationResult.suggestions && moderationResult.suggestions.length > 0 && (
          <div className="p-3 bg-purple-500/10 rounded-lg border border-purple-500/20">
            <p className="text-purple-200 text-sm font-medium mb-2">Suggestions:</p>
        ...
        {moderationResult.action === "approved" && (
          <div className="flex items-center space-x-2 pt-2">
            <span className="text-gray-400 text-xs">How was this experience?</span>
            <Button
              variant="ghost"
              size="sm"
