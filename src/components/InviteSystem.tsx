    ...
    <div className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="p-4 bg-blue-500/10 rounded-lg border border-blue-500/20">
            <p className="text-blue-200 text-sm">
              Enter your college email for one-time verification. We'll send an OTP and immediately forget your email address.
            </p>
          </div>
        ...
        <div className="space-y-4">
          <div className="flex space-x-2">
            <Input
              ...
              className="bg-white/5 border-white/20 text-white placeholder:text-gray-400"
            />
            <Button onClick={validateInvite} className="bg-green-600 hover:bg-green-700">
              Verify
            </Button>
          </div>
        </div>
      ...
      <Card className="bg-white/5 backdrop-blur-md border-white/10 p-6">
        ...
        <div className="space-y-4">
          ...
          >
            {isGenerating ? "Generating Secure Code..." : "Generate Invite Code"}
          </Button>
          ...
          {generatedCode && (
            <div className="p-4 bg-green-500/10 rounded-lg border border-green-500/20">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-green-200 font-mono text-lg">{generatedCode}</p>
                  <p className="text-green-300 text-xs">Share this code carefully</p>
                </div>
                <Button
                  variant="ghost"
                  size="sm"
