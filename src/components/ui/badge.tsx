  ...
  "inline-flex items-center rounded-full border-2 px-3 py-1 text-xs font-bold transition-colors focus:outline-none focus:ring-2 focus:ring-primary/60 focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        outline: "text-primary border-primary/40 bg-transparent hover:bg-primary/10",
        glass: "glass text-primary border-white/20 hover:bg-primary/20",
        success: "border-accent/40 bg-accent/20 text-accent backdrop-blur-md hover:bg-accent/30",
        warning: "border-yellow-500/40 bg-yellow-500/20 text-yellow-500 backdrop-blur-md hover:bg-yellow-500/30",
