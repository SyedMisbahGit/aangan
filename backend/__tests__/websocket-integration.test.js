...
describe('WebSocket Server Integration', () => {
  ...
  test('should connect and subscribe to a channel', (done) => {
  ...
  test('should handle multiple clients in the same channel', (done) => {
  ...
  test('should handle multiple channels', (done) => {
  ...
  test('should not receive messages after unsubscribing', (done) => {
