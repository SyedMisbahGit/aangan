...
import { useWhispers } from "../contexts/useWhispers";
import { useShhhNarrator } from "../contexts/useShhhNarrator";
...
const CreateWhisper: React.FC = () => {
  ...
  return (
    <ErrorBoundary narratorLine="A gentle hush falls over the campus. Something went adrift in create whisper.">
      <main
        role="main"
        aria-labelledby="page-title"
        tabIndex={-1}
        ref={mainRef}
        className="aangan-container"
      >
        <h1 id="page-title" className="sr-only">Create Whisper</h1>
        <AanganHeader 
